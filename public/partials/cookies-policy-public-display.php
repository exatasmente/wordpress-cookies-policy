...
<div class="permission-use-cookies" role="dialog" id="inversa-cookies-policy-component">
    <div class="permission-use-cookies-content">
        <span  class="permission-use-cookies-message">
            ...
            <a  href="http://inversapub.com/politica-de-privacidade" class="permission-use-cookies-message-link">Política de Utilização de Cookies.</a>
        </span>
        <div class="permission-use-cookies-actions">
            <a id="allow-cookies-button" role="button" tabindex="0" class="permission-use-cookies-button">Prosseguir</a>
        </div>
    </div>
</div>
